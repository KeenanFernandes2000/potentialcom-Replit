        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-secondary-foreground/70">
                        From concept to implementation in days
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="md:w-1/2" data-aos="fade-left">
            ...
            <p className="text-xl mb-8 text-secondary-foreground/90">
              While others take months to implement AI solutions, our pre-built
              agents can be deployed in hours. We've designed our platform for
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {metrics.map((metric, index) => (
                <div
                  key={index}
                  className="bg-primary/10 p-5 rounded-xl text-center"
                >
