  ...
  const benefits = [
    {
      ...
      description:
        "Ready in hours, not months. Get your AI agents up and running quickly.",
    },
    {
      icon: <Puzzle className="h-10 w-10" />,
      title: "Seamless Integration",
      description:
        "Bolt-on to existing APIs and systems without disrupting workflows.",
    },
    {
      icon: <HeadphonesIcon className="h-10 w-10" />,
      title: "Fully Supported Setup",
      description:
        "Dedicated team onboarding ensures a smooth transition to AI-powered workflows.",
    },
    {
    ...
    },
    {
      ...
      description:
        "100+ agent templates across Leadership, Sales, Operations, and more.",
    },
    {
      icon: <History className="h-10 w-10" />,
      title: "20 Years of Empowerment",
      description:
        "Backed by two decades of experience in organizational transformation.",
    },
  ];
      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="section-title text-center">
            ...
            <span className="text-primary">Our AI Agents</span>
          </h2>
