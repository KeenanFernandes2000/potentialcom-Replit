  ...
  const chatMessages = [
    {
      sender: "vera",
      message:
        "Hi there! I'm Vera, your AI business consultant. How can I help you today?",
      time: "Just now",
    },
    {
      sender: "user",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="lg:w-3/5 order-1 lg:order-2" data-aos="fade-left">
            ...
            <h2 className="section-title mb-6">
              Meet <span className="text-primary">Vera</span>: Your 24/7 AI
              Business Consultant
            </h2>
            <p className="text-xl text-muted-foreground mb-8">
              Vera is your intelligent assistant who answers your questions,
