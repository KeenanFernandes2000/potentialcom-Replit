...
const CTAFooter = () => {
  ...
  return (
    <section
      id="cta-footer"
      className="py-24 bg-secondary dark:bg-secondary/90 text-secondary-foreground relative overflow-hidden"
    >
      {/* Decorative elements */}
      ...
      <div className="container relative z-10 text-center">
        ...
        >
          ...
          <h2
            ...
            data-aos="fade-up"
          >
            Get Started with <span className="text-primary">Rachel</span> – Your
            AI Growth Partner!
          </h2>
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Ready to transform your business with AI? Let Rachel guide you
            through the perfect solution for your needs. Our team will help you
            implement the right AI agents for your specific challenges.
          </p>

          <div className="flex flex-wrap justify-center gap-4">
            <Button
              onClick={goToRachel}
              className="rounded-full bg-primary hover:bg-primary/90 text-white font-semibold px-8 py-6 shadow-lg gtm-cta-footer-talk-to-rachel"
              size="lg"
              data-aos="fade-up"
              data-aos-delay="200"
            >
            ...
            <Button
              variant="outline"
              className="rounded-full border-primary/30 text-foreground hover:bg-primary/10 px-8 py-6 gtm-cta-footer-schedule-demo"
              size="lg"
              data-aos="fade-up"
              data-aos-delay="250"
            >
            ...
            <div className="flex items-center">
              <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center text-primary mr-3">
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M14 19a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1v12Z"></path>
                  <path d="M14 2h4a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1h-4"></path>
                  <path d="M9 11v5"></path>
                  <path d="M9 11a2 2 0 0 0-2-2"></path>
                  <path d="M9 11a2 2 0 0 1-2 2"></path>
                </svg>
              </div>
              <div className="text-left">
