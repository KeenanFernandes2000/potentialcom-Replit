...
const GettingStarted = () => {
  const steps = [
    {
      ...
      description:
        "Choose from 100+ templates designed for specific business functions",
    },
    {
      number: "02",
      title: "Customize & Integrate",
      description:
        "Connect to existing workflows and tailor the agent to your needs",
    },
    {
      number: "03",
  ...
  const features = [
    {
      title: "Simple Setup",
      description:
        "We handle the technical complexity so you can focus on results",
    },
    {
  ...
  return (
    <section
      id="getting-started"
      className="py-24 bg-muted/30 dark:bg-secondary/5 relative"
    >
      {/* Decorative element */}
