      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="section-title text-center">
            ...
            <span className="text-primary">Agentic AI Workflows</span>
          </h2>
              ...
              >
                ...
                <CardContent className="p-3 flex-grow">
                  <div className="flex justify-between items-center mb-1">
                    <Badge
                      variant="outline"
                      className="bg-muted/50 text-xs px-2 py-0 h-5"
                    >
                      {tool.category}
                    </Badge>
                    {tool.popular && (
        ...
        <div className="mt-16 text-center">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <button className="inline-flex items-center rounded-full bg-primary/10 hover:bg-primary/20 text-primary px-6 py-3 font-medium transition-colors">
