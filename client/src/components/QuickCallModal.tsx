    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden">
        ...
        <div className="relative">
          {/* Avatar Section */}
          <div className="relative bg-gradient-to-b from-primary/10 to-background p-8 pb-6">
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <h3 className="text-xl font-semibold mb-1">Vera</h3>
          ...
          {micPermissionError && (
            <div className="px-6 py-4 bg-destructive/10 border-l-4 border-destructive">
              <p className="text-sm text-destructive">{micPermissionError}</p>
            </div>
          )}
          ...
          <div className="p-6 space-y-4">
            ...
            {isTranscriptVisible && (
              <div 
                ...
                className="max-h-60 overflow-y-auto border rounded-lg p-4 space-y-2 bg-muted/30"
              >
                ...
                {currentPartial && (
                  <div 
                    className={`text-sm p-2 rounded opacity-60 ${
                  ...
                  >
                    ...
                    <p className="mt-1">{currentPartial.text}</p>
                  </div>
                )}
              </div>
            )}
