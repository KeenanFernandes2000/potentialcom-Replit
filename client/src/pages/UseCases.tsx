...
const useCases = [
  ...
  },
  {
    ...
    tasks: ["Capture Leads", "Suggest Products/Services", "Follow-ups"],
    channels: ["Phone", "Website", "WhatsApp"],
    interface: ["Voice", "Chat"],
    industry: "Sales",
  ...
  },
  {
    ...
    tasks: ["Send Campaigns", "Collect Feedback", "Follow-ups"],
                  ...
                  <Card key={useCase.id} className="glass-effect border-border rounded-xl overflow-hidden card-hover h-full">
                    <CardContent className="p-6 flex flex-col h-full">
                      ...
                      <div className="space-y-3 mb-6">
                        ...
                        <div>
                          <span className="text-xs text-muted-foreground mb-1 block font-bold">INTERFACE</span>
                          <div className="flex flex-wrap gap-1">
