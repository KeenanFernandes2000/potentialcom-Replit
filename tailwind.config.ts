  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        // Voice-orb breathing pulse — opacity-only fade used as a quiet
        // ambient signal on the avatar ring while Ruby is on a call.
        // Faster/larger only while she's actively speaking.
        "voice-breathe": {
          "0%, 100%": { opacity: "0.4" },
          "50%": { opacity: "1" },
        },
